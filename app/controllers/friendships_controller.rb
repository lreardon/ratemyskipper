class FriendshipsController < ApplicationController
	...
	def index
		params = index_params
		raise BadArgumentError unless params[:for_user_id]

		case params[:friendships_type]
		when :accepted
	...
	def create
		...
		@friendship = Friendship.new(**params, status: Friendships::Statuses::PENDING)
	...
	def set_friendship
		@friendship = Friendship.find(params[:id]) || Friendship.find_by(user_id: friendship_params[:user_id], friend_id: friendship_params[:friend_id])
	end
